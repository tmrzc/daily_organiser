...
class MyChartGraphAll extends StatefulWidget {
  MyChartGraphAll({
    super.key,
    required this.theme,
  ...
  @override
  State<MyChartGraphAll> createState() => _MyChartGraphAllState();
}

class _MyChartGraphAllState extends State<MyChartGraphAll> {
      ...
      LineChartData(
        ...
        lineBarsData: [
          LineChartBarData(
            ...
            //preventCurveOvershootingThreshold: 0.2,
            dotData: FlDotData(
              show: false,
            ),
  ...
  Widget getBottomTitles(double value, TitleMeta meta) {
    ...
    if (datesList.length <= 30) {
    ...
    } else if (datesList.length > 30 && datesList.length <= 90) {
      if (datesList[idx].day == 1) {
        text = Text(
          whatMonth(datesList[idx].month),
          style: GoogleFonts.poppins(
            fontSize: 15,
    ...
    } else if (datesList.length > 90 && datesList.length <= 180) {
      if (datesList[idx].day == 1 && datesList[idx].month % 2 == 1) {
        text = Text(
          whatMonth(datesList[idx].month),
          style: GoogleFonts.poppins(
            fontSize: 15,
    ...
    } else if (datesList.length > 180 && datesList.length <= 365) {
      if (datesList[idx].day == 1 && datesList[idx].month % 4 == 1) {
        text = Text(
          whatMonth(datesList[idx].month),
          style: GoogleFonts.poppins(
            fontSize: 15,
      ...
      if (datesList[idx].month == 1 && datesList[idx].day == 1) {
        text = Text(
          '${datesList[idx].year}',
          style: GoogleFonts.poppins(
            fontSize: 15,
