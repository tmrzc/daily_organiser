...
class MyChartGraph90 extends StatefulWidget {
  MyChartGraph90({
    super.key,
    required this.theme,
  ...
  @override
  State<MyChartGraph90> createState() => _MyChartGraph90State();
}

class _MyChartGraph90State extends State<MyChartGraph90> {
